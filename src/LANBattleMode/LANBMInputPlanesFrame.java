...
public class LANBMInputPlanesFrame extends JFrame{
	...
	public LANBMInputPlanesFrame(LANBMFindEnemyFrame myfindEnemyFrame) {
		...
		removeAllJB.addActionListener(new ActionListener() { // 为按钮添加鼠标单击事件
			public void actionPerformed(ActionEvent e) {
				if(BattleModeAlreadySent) {
					TextDialog AlreadySentDl=new TextDialog(LANBMInputPlanesFrame.this,"提交信息",
											...
											if(AlreadyChooseCenter==false) {
												...
												if(InputtedcenterRow==FiMinus1&&InputtedcenterColumn==FjMinus1) {
													...
													if(myInputEnemy.addPlane(plane)) {
														...
														String text="飞机输入不合法！";
														TextDialog txtDl=new TextDialog(LANBMInputPlanesFrame.this,"提示",text);
														Dimension screensize=Toolkit.getDefaultToolkit().getScreenSize();
				...
				if(BattleModeAlreadySent==false) {
					if(InputtingPlane>3) {
						...
						if(messageHandler.getCodeReceiveFromEnemy()==-1) {
							TextDialog SentSuccessDl=new TextDialog(LANBMInputPlanesFrame.this,"提交信息",
						...
						TextDialog txtDl=new TextDialog(LANBMInputPlanesFrame.this,"提交信息",text);
						Dimension screensize=Toolkit.getDefaultToolkit().getScreenSize();
						txtDl.setSize(400, 200); 
						txtDl.setLocation((int)screensize.getWidth()/2-200,(int)screensize.getHeight()/2-100);
						txtDl.setVisible(true);
