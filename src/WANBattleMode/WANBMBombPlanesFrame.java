...
public class WANBMBombPlanesFrame extends JFrame{
	...
	public WANBMBombPlanesFrame(WANBMFindEnemyFrame myfindEnemyFrame,int InputCode,int codeReceive,boolean isFirst) {
								...
								switch(e.getButton()) {
									case 1:
										if(IsMyRound) {
											...
											BombMessageJDialog bmjd=new BombMessageJDialog(WANBMBombPlanesFrame.this,locationMessage,step,bombedPlane,repeat);
											...
											TextDialog txtDl=new TextDialog(WANBMBombPlanesFrame.this,"提示","现在是对手的回合！");
											Dimension screensize=Toolkit.getDefaultToolkit().getScreenSize();
